...
TEST_CASE("ranges view")
{
...

    {
        ...
        auto const result =
            "ic| range_view_32:83[0]: 10\n"
            "ic| range_view_32:83[1]: 11\n";
      #elif defined(ICECREAM_SOURCE_LOCATION)
        auto const result =
            "ic| range_view_32:78[0]: 10\n"
            "ic| range_view_32:78[1]: 11\n";
      #else
        auto const result =
            "ic| range_view_32[0]: 10\n"
            "ic| range_view_32[1]: 11\n";
      #endif
        REQUIRE(str == result);
    }

    {
        ...
        for (auto i : v0){(void)i;}
      #if defined(ICECREAM_SOURCE_LOCATION) && defined(__clang__)
        auto const result = "ic| range_view_57:79[0]: 12\n";
      #elif defined(ICECREAM_SOURCE_LOCATION)
        auto const result = "ic| range_view_57:39[0]: 12\n";
      #else
        auto const result = "ic| range_view_57[0]: 12\n";
      #endif
        REQUIRE(str == result);
    }

    {
      ...
      #if defined(ICECREAM_SOURCE_LOCATION) && defined(__clang__)
        auto const result =
            "ic| range_view_76:73[0]: 0xa\n"
            "ic| range_view_76:73[1]: 0xb\n";
      #elif defined(ICECREAM_SOURCE_LOCATION)
        auto const result =
            "ic| range_view_76:25[0]: 0xa\n"
            "ic| range_view_76:25[1]: 0xb\n";
      #else
        auto const result =
            "ic| range_view_76[0]: 0xa\n"
            "ic| range_view_76[1]: 0xb\n";
      #endif
        REQUIRE(str == result);
    }
