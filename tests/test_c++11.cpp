...
{
    {
        ...
        auto tree = icecream::detail::make_printing_branch(v0, "", icecream_private_config_5f803a3bcdb4);
...
{
    {
        ...
        IC_CONFIG.output_transcoder(
            [](char const* strg, std::size_t count) -> std::string
            {
                return std::string(strg, count) + "|";
            }
        );
